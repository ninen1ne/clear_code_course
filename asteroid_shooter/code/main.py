...
ship_rect = ship_surf.get_frect(center = (WINDOW_WIDTH/2, WINDOW_HEIGHT/2))
...
while True: # run forever  -> keeps our code running 
	# framerate limit 
	...
	for event in pygame.event.get():
		...
		if event.type == meteor_timer:
			...
			# create a rect
			meteor_rect = meteor_surf.get_frect(center = (x_pos, y_pos))
	...
	# we need 2 for loops -> one for meteor and one for laser
